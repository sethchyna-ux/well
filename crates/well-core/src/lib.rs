...
pub enum SubsystemEvent {
    PtyOutputReceived { surface_id: SurfaceId, byte_count: usize },
    UserKeystroke { key: String, is_ctrl: bool, is_alt: bool },
    SplitCreated { parent_id: SurfaceId, child_id: SurfaceId, is_horizontal: bool },
    SurfaceClosed { surface_id: SurfaceId },
    ThemeReloaded { theme_id: u32 },
    AiTranslationCompleted { query_len: usize, duration_us: u64 },
}
...
impl SessionCoordinator {
    ...
    pub fn create_session(&mut self, title: impl Into<String>, shell: impl Into<String>, rows: u16, cols: u16) -> SurfaceId {
        self.next_id += 1;
