...
lazy_static! {
    ...
    pub static ref RENDER_FRAME_TIME_HISTOGRAM: Histogram = Histogram::with_opts(histogram_opts!(
    ...
    pub static ref PTY_READ_LATENCY_HISTOGRAM: Histogram = Histogram::with_opts(histogram_opts!(
    ...
    pub static ref LLM_TRANSLATION_DURATION: Histogram = Histogram::with_opts(histogram_opts!(
